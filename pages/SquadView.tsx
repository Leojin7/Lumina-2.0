...
import { LogOut, Send, BrainCircuit, Users, Play, Pause, RotateCcw, Copy, Check, Lock } from 'lucide-react';
...
const SquadView: React.FC = () => {
  ...
  const {
    ...
    squad: state.getSquadById(squadId || ''),
    leaveSquad: state.leaveSquad,
    sendMessage: state.sendMessage,
    postAIMessage: state.postAIMessage,
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    if (chatInput.trim() && squadId) {
      sendMessage(squadId, chatInput.trim());
      setChatInput('');
    }
  };
